...
This module contains libraries written in LayerDocs ([main/resources](src/main/resources)).
...
See [wiki: *Importing external libraries*](https://layerdocs.com/wiki/importing-external-libraries) for further information.
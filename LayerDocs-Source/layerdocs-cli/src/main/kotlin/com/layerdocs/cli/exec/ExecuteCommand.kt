...
import com.layerdocs.cli.server.DEFAULT_SERVER_PORT
import com.layerdocs.cli.util.runWithTimeout
import com.layerdocs.cli.watcher.DirectoryWatcher
import com.layerdocs.core.TIMEOUT_EXIT_CODE
 ...
 */
const val DEFAULT_OUTPUT_DIRECTORY = "layerdocs-output"
...
/**
 * Template for LayerDocs commands that launch a complete pipeline and produce output files.
...
abstract class ExecuteCommand(
     ...
     * @see com.layerdocs.core.template.TemplateProcessor
     */
    ...
    fun createCliOptions(): CliOptions =
        CliOptions(
            ...
            source = null,
            outputDirectory,
            libraryDirectory = libraryDirectory ?: InstallLayout.get.layerdocsLibraries.file,
            renderer,
            clean,
            pipe = false,
            nodePath,
    ...
    override fun run() {
        ...
        // Executes the LayerDocs pipeline.
        execute(cliOptions, pipelineOptions)
    }

    /**
     * Executes the LayerDocs pipeline: compiles and generates output files.
    ...
    private fun execute(
        ...
        val outcome: ExecutionOutcome =
            runWithTimeout(
                ...
                runLayerDocs(strategy, cliOptions, pipelineOptions)
            }

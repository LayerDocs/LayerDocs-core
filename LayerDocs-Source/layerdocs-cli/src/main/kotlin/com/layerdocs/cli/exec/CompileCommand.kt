...
import com.layerdocs.cli.exec.strategy.FileExecutionStrategy
import com.layerdocs.cli.server.WebServerOptions
import com.layerdocs.cli.server.browserLauncherOption
import com.layerdocs.cli.util.MillisStopwatch
...
import com.layerdocs.server.browser.BrowserLauncher
import com.layerdocs.server.browser.DefaultBrowserLauncher
...
/**
 * Command to compile a LayerDocs file into an output.
 * @see FileExecutionStrategy
 */
class CompileCommand : ExecuteCommand("compile") {
    /**
     * LayerDocs source file to process.
     */
    ...
    private fun runServerCommunication(directory: File) {
        ...
        // (this is shorthand for `layerdocs start -f <generated directory> -p <server port> -b default`).

package com.layerdocs.cli.creator.command
...
import com.layerdocs.cli.creator.ProjectCreator
import com.layerdocs.cli.creator.content.DefaultProjectCreatorInitialContentSupplier
import com.layerdocs.cli.creator.content.DefaultTheme
import com.layerdocs.cli.creator.content.DocsProjectCreatorInitialContentSupplier
import com.layerdocs.cli.creator.content.EmptyProjectCreatorInitialContentSupplier
import com.layerdocs.cli.creator.template.DefaultProjectCreatorTemplateProcessorFactory
import com.layerdocs.cli.creator.template.DocsProjectCreatorTemplateProcessorFactory
import com.layerdocs.core.document.DocumentAuthor
import com.layerdocs.core.document.DocumentInfo
import com.layerdocs.core.document.DocumentTheme
...
/**
 * Command to create a new LayerDocs project with a default template.
 */
class CreateProjectCommand : CliktCommand("create") {
    ...
    private val type: DocumentType by option("--type", help = "Document type")
        .enum<DocumentType> { it.layerdocsName }
        .prompt(
            styledPrompt("Document type", "(${DocumentType.entries.joinToString(", ") { it.layerdocsName }})"),
    ...
    override fun run() {
        ...
        echo()
        echo("  ${dim("Compile:")}       ${cyan("layerdocs c $mainFile")}")
        echo("  ${dim("Live preview:")}  ${cyan("layerdocs c $mainFile -p -w")}")
    }
}

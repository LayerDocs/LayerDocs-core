...
import com.layerdocs.cli.renderer.RendererRetriever
import java.io.File

/**
 * Options that affect the behavior of the LayerDocs CLI, especially I/O.
 * For pipeline-related options, see [com.layerdocs.core.pipeline.PipelineOptions].

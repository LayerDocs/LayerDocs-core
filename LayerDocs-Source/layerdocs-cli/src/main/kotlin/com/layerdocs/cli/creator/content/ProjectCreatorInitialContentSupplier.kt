...
/**
 * Supplier of the initial content of a new LayerDocs project.
 * This includes:
 * - Code content that goes into the main file
 * - Additional resources (e.g. assets)
 * @see com.layerdocs.cli.creator.ProjectCreator
 */
interface ProjectCreatorInitialContentSupplier {
    /**
     * @return the code content that is inserted into the main file.
     * This code will be processed by the same template processor used by the [com.layerdocs.cli.creator.ProjectCreator].

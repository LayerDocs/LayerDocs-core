...
import com.layerdocs.test.util.INDEX
import com.layerdocs.test.util.execute
import com.layerdocs.test.util.getMediaResources
...
class MediaStorageTest {
    ...
    fun `local media, no media storage`() {
        execute(
            """
            This is the LayerDocs logo: ![LayerDocs](img/icon.png).                                 
            """.trimIndent(),
            ...
            assertEquals("<p>This is the LayerDocs logo: <img src=\"img/icon.png\" alt=\"LayerDocs\" />.</p>", it)
    ...
    fun `local media, with media storage`() {
        execute(
            ...
            assertEquals("<p>This is the LayerDocs logo: <img src=\"media/icon", it.toString().substringBefore("@"))
            // The file name is "media/icon-[encoded].png"
            assertEquals("\" alt=\"LayerDocs\" />.</p>", it.toString().substringAfter(".png"))
        }
    }
    ...
    fun `remote media, with media storage`() {
        execute(
            """
            .container
                ![Icon](https://raw.githubusercontent.com/SatyamPote/layerdocs/project-files/images/ticon-light.svg "The LayerDocs icon")
            ...
            outputResourceHook = { group ->
                assertEquals(
                    "https-raw.githubusercontent.com-SatyamPote-layerdocs-project-files-images-ticon-light.svg",
            ...
            assertEquals(
                "<div class=\"container\">" +
                    "<figure>" +
                    "<img src=\"media/https-raw.githubusercontent.com-SatyamPote-layerdocs-project-files-images-ticon-light.svg\" " +
                    "alt=\"Icon\" title=\"The LayerDocs icon\" />" +
                    "<figcaption class=\"caption-bottom\">The LayerDocs icon</figcaption>" +
                    "</figure>" +
                    "<figure>" +
                    "<img src=\"media/https-raw.githubusercontent.com-SatyamPote-layerdocs-project-files-images-tbanner-light.svg\" " +
                    "alt=\"Banner\" />" +
                    "</figure>" +
                    "</div>",
                it,
    ...
    fun `remote and local media, with local media storage only`() {
        execute(
            ...
            assertEquals(
                "<p>" +
                    "<img src=\"https://raw.githubusercontent.com/SatyamPote/layerdocs/project-files/images/tbanner-light.svg\" " +
    ...
    fun `remote and local media, with media storage`() {
        execute(
            ...
            assertEquals(
                "<p><img src=\"media/https-raw.githubusercontent.com-SatyamPote-layerdocs-project-files-images-tbanner-light.svg\" " +
                    "alt=\"Banner\" /></p>",
                it,
            )
        }

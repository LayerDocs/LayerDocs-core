...
class ScriptingTest {
    ...
    fun `flow functions`() {
        ...
        execute(
            ...
            assertEquals("<h4>Hello, <em>world</em>!</h4><p>Hello, <em>SatyamPote</em>!</p>", it)
        }
    ...
    fun `layout builder`() {
        ...
        execute(
            ...
            This **exciting feature**, .poweredby {[LayerDocs](https://github.com/SatyamPote/layerdocs)}, looks great!
            """.trimIndent(),
        ) {
            assertEquals(
                "<p>This <strong>exciting feature</strong>, <span class=\"size-small\" style=\"font-variant: small-caps;\">" +
                    "powered by <a href=\"https://github.com/SatyamPote/layerdocs\">LayerDocs</a></span>, looks great!</p>",
                it,
            )
        }

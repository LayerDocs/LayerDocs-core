...
class TextTest {
    ...
    fun `text replacement`() {
        execute(
            ...
            > This is a feature of LayerDocs--the Turing complete Markdown--by SatyamPote (C) 2024 - all rights reserved.
            > => LayerDocs != other Markdown flavors... <-
            """.trimIndent(),
        ) {
            assertEquals(
                "<blockquote><p>" +
                    "This is a <strong>&ldquo;quote&rdquo;</strong> with &lsquo;text <em>replacement</em>&rsquo;.<br />" +
                    "This is a feature of LayerDocs&mdash;the Turing complete Markdown&mdash;by SatyamPote &copy; 2024 " +
                    "&ndash; all rights reserved.\n" +
                    "&rArr; LayerDocs &ne; other Markdown flavors&hellip; &larr;" +
                    "</p></blockquote>",
                it,
            )
        }
        ...
        execute(
            ...
            assertEquals(
                "<blockquote class=\"tip\" style=\"--quote-type-label: 'Consiglio';\" data-labeled=\"\">" +
                    "<p>you could try LayerDocs.<br />" +
                    "It&rsquo;s a cool language!</p>" +
                    "<p class=\"attribution\"><strong>SatyamPote</strong></p>" +
                    "</blockquote>" +

...
dependencies {
    ...
    implementation(project(":layerdocs-plaintext")) // For search index generation
...
val bundleTypeScript =
    tasks.register<NpxTask>("bundleTypeScript") {
        group = "build"
        description = "Bundles TypeScript files using esbuild into build/install/script/layerdocs.min.js"
        ...
        outputs.file(layout.buildDirectory.file("install/script/layerdocs.min.js"))
        outputs.file(layout.buildDirectory.file("install/script/layerdocs.min.js.map"))
        ...
        args.set(
            listOf(
                ...
                "--format=iife",
                "--minify",
                "--outfile=build/install/script/layerdocs.min.js",
                "--sourcemap",

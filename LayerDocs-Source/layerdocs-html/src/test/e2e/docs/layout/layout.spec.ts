...
test("header and content-wrapper have full viewport width", async (page) => {
    ...
    const header = page.locator(".layerdocs-docs > header");
    const contentWrapper = page.locator(".layerdocs-docs > .content-wrapper");
...
test("header and content-wrapper columns are aligned", async (page) => {
    const headerAsideFirst = page.locator(".layerdocs-docs > header > aside:first-child");
    const headerMain = page.locator(".layerdocs-docs > header > main");
    const headerAsideLast = page.locator(".layerdocs-docs > header > aside:last-child");

    const contentAsideFirst = page.locator(".layerdocs-docs > .content-wrapper > aside:first-child");
    const contentMain = page.locator(".layerdocs-docs > .content-wrapper > main");
    const contentAsideLast = page.locator(".layerdocs-docs > .content-wrapper > aside:last-child");
...
test("search field aligns with main content first child", async (page) => {
    const searchField = page.locator(".layerdocs-docs > header > main .search-field");
    const mainFirstChild = page.locator(".layerdocs-docs > .content-wrapper > main > :first-child");

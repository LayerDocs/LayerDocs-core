...
async function getLayoutWidths(page: any): Promise<LayoutWidths> {
    const [
        ...
        page.locator(".layerdocs-docs > header > aside:first-child").boundingBox(),
        page.locator(".layerdocs-docs > header > main").boundingBox(),
        page.locator(".layerdocs-docs > header > aside:last-child").boundingBox(),
        page.locator(".layerdocs-docs > .content-wrapper > aside:first-child").boundingBox(),
        page.locator(".layerdocs-docs > .content-wrapper > main").boundingBox(),
        page.locator(".layerdocs-docs > .content-wrapper > aside:last-child").boundingBox(),
    ]);

...
const DEFAULT_CLI_PATH = path.join(PROJECT_ROOT, "build/install/layerdocs/bin/layerdocs");

export const CLI_PATH = process.env.LAYERDOCS_CLI_PATH || DEFAULT_CLI_PATH;

/**
 * Compiles a LayerDocs source file to HTML.

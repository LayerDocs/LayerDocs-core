 ...
 * @param value - CSS value to compute (e.g., "var(--ld-link-color)", "1.3em")
 ...
 * @param value - CSS value to compute (e.g., "var(--ld-block-margin)", "1.3em")
 ...
 * @param context - Playwright locator or Page for context
 * @param value - CSS color value (e.g., "var(--ld-link-color)", "hsl(0, 100%, 50%)")

...
import {PagedLikeLayerDocsDocument} from "../../paged-like-layerdocs-document";

class DummyDocument implements PagedLikeLayerDocsDocument<HTMLElement> {
...
describe('PageNumbersDocumentHandler', () => {
    it('respects page number reset markers when numbering pages', async () => {
        document.body.className = 'layerdocs layerdocs-paged';

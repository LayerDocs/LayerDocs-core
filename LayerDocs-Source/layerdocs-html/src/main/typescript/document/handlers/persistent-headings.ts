 ...
 */
export class PersistentHeadings extends DocumentHandler<PagedLikeLayerDocsDocument<any>> {
    /**
     ...
     */
    private overwriteLastHeadings(page: LayerDocsPage) {
     ...
     */
    private applyLastHeadings(page: LayerDocsPage) {

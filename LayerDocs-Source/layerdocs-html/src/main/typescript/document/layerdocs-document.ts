...
/**
 * Core interface for LayerDocs document types.
 * Defines the document rendering lifecycle and management.
 */
export interface LayerDocsDocument {
    /**
...
/**
 * Prepares a LayerDocs document for rendering by setting up handlers and hooks.
 * This is called by the HTML wrapper.
 * @param document - The document to prepare for rendering
 */
export function prepare(document: LayerDocsDocument): void {

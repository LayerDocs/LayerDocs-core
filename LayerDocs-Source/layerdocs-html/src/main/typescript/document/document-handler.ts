 ...
 * @template TDoc - The type of LayerDocs document this handler manages
 */
export abstract class DocumentHandler<TDoc extends LayerDocsDocument = LayerDocsDocument> {
    /**
     * @param layerdocsDocument - The document instance this handler manages
     */
    constructor(protected readonly layerdocsDocument: TDoc) {
    }

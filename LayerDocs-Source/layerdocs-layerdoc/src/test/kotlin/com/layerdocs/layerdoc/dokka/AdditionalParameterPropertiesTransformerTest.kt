...
/**
 * Tests for [com.layerdocs.layerdoc.dokka.transformers.optional.AdditionalParameterPropertiesTransformer].
 */
class AdditionalParameterPropertiesTransformerTest :
    LayerDocDokkaTest(
        ...
        stringPaths = listOf(LikelyBody::class.java.packageName + ".LayerDocAnnotations"),
    ) {

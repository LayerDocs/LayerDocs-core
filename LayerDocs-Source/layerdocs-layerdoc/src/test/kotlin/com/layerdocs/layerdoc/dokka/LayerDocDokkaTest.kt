...
import com.layerdocs.layerdoc.dokka.transformers.name.RenamingsStorage
...
private val CORE_SOURCE_DIR = File("../layerdocs-core/src/main/kotlin").absolutePath
...
/**
 * Base class for Dokka-based LayerDoc tests.
 * @param rootPackage the root package for the test source
 */
open class LayerDocDokkaTest(
    ...
    protected fun test(
        ...
        testInline(
            ...
            pluginOverrides = listOf(LayerDocDokkaPlugin(), writerPlugin),
        ) {
            renderingStage = { _, _ ->
                Log.info(

package com.layerdocs.layerdoc.dokka.transformers.optional
...
import com.layerdocs.core.function.value.factory.ValueFactory.enum
import com.layerdocs.layerdoc.dokka.kdoc.buildDocTags
import com.layerdocs.layerdoc.dokka.page.WIKI_ROOT
...
) : LayerDocParameterDocumentationTransformer<AdditionalParameterPropertiesTransformer.ParameterProperties>(context) {
    /**

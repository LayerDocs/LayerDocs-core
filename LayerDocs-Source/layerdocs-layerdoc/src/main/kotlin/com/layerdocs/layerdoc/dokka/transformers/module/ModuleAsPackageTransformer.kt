...
import com.layerdocs.core.util.filterNotNullEntries
import com.layerdocs.layerdoc.dokka.transformers.LayerDocDocumentableReplacerTransformer
import com.layerdocs.layerdoc.dokka.util.difference
...
/**
 * A synthetic module is a LayerDocs [com.layerdocs.core.function.library.loader.Module] that is defined in a source file.
 ...
 * @param dri the DRI to the [com.layerdocs.core.function.library.loader.Module] property definition.
...
/**
 * Given a list of functions, extracts the LayerDocs modules that they belong to, according to [LayerDocsModulesStorage].
...
private fun extractSyntheticModules(functions: List<DFunction>): List<SyntheticModule> =
    functions
        .groupBy { function ->
            ...
            LayerDocsModulesStorage[sourcePath]
        }.asSequence()
        .map { it.toPair() }
...
/**
 * Transformer that transforms a LayerDocs [com.layerdocs.core.function.library.loader.Module]

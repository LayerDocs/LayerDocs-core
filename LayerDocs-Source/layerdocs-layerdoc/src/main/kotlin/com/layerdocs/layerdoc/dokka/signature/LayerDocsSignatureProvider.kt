package com.layerdocs.layerdoc.dokka.signature
...
import com.layerdocs.layerdoc.dokka.util.documentableContentBuilder
...
/**
 * Signature provider for LayerDocs functions.
 * @param requireModule whether to require the function to be in a LayerDocs module
 ...
 */
class LayerDocsSignatureProvider(
    ...
    override fun signature(documentable: Documentable): List<ContentNode> {
        if (requireModule && !LayerDocsModulesStorage.isModule(documentable)) {

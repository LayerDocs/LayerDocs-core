...
/**
 * Type-safe navigator over the LayerDocs install `lib/` directory layout.
 *
...
class InstallLayout(
    ...
    val layerdocsLibraries get() = resolveDirectory("qd")
    ...
    class Html(
        ...
        /** The LayerDocs runtime script directory. */

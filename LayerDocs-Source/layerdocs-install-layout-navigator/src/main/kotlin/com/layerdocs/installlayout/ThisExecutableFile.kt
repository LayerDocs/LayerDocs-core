 ...
 *
 * Since this property is defined in `layerdocs-install-layout-navigator`, its location is
 * determined by Gradle's dependency resolution: consumers see it as the module's JAR
 * (e.g. `layerdocs-install-layout-navigator/build/libs/...`) in dev, or as one of the JARs

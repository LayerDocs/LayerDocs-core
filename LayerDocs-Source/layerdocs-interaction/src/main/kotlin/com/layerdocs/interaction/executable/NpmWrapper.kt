 ...
 * - [com.layerdocs.interaction.Env.QD_NPM_PREFIX]: if set, determines the global prefix for NPM operations.
 * - [com.layerdocs.interaction.Env.NODE_PATH]: if set, determines the path to the Node.js modules.
 *
...
class NpmWrapper(
    ...
    companion object : WithDefaultPath {
         ...
         * @see [com.layerdocs.interaction.os.OsUtils.cmdBasedExecutablePath]
         */

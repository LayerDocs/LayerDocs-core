package com.layerdocs.lsp.tokenizer

import com.github.h0tk3y.betterParse.lexer.TokenMatch
import com.layerdocs.core.flavor.layerdocs.LayerDocsLexerFactory
import com.layerdocs.core.util.offset
import com.layerdocs.core.lexer.tokens.FunctionCallToken as CoreFunctionCallToken
...
class FunctionCallTokenizer {
    ...
    fun getFunctionCalls(text: String): List<FunctionCall> {
        val lexer = LayerDocsLexerFactory.newInlineFunctionCallLexer(text)

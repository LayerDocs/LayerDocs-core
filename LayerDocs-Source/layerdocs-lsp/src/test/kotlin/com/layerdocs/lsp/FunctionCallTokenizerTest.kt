...
import com.layerdocs.lsp.tokenizer.FunctionCallTokenizer
...
/**
 * Tests for [com.layerdocs.lsp.tokenizer.FunctionCallTokenizer].
 *
...
class FunctionCallTokenizerTest {
    ...
    fun `simple function call tokenization`() {
        ...
        assertEquals(LayerDocsPatterns.FunctionCall.BEGIN, beginToken.lexeme)
    ...
    fun `function call with named parameter`() {
        ...
        assertEquals(LayerDocsPatterns.FunctionCall.NAMED_ARGUMENT_DELIMITER, delimiterToken.lexeme)
    }
    ...
    fun `function call with inline argument`() {
        ...
        assertNotNull(beginToken)
        assertEquals(LayerDocsPatterns.FunctionCall.ARGUMENT_BEGIN, beginToken.lexeme)
        ...
        assertEquals(LayerDocsPatterns.FunctionCall.ARGUMENT_END, endToken.lexeme)
    }

...
class PlainTextNodeRendererTest {
    private fun Node.render(context: Context = MutableContext(LayerDocsFlavor)) = this.accept(PlainTextNodeRenderer(context))

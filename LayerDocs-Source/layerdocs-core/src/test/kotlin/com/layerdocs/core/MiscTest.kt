...
import com.layerdocs.core.pipeline.output.visitor.FileResourceExporter
...
class MiscTest {
    @Test
    fun `resource export`() {
        val dir = Files.createTempDirectory("layerdocs-resource-test")
        ...
        val group =
            OutputResourceGroup(
                ...
                setOf(
                    ...
                    BinaryOutputArtifact("arti-fact6", "LayerDocs".toByteArray().toList(), ArtifactType.JAVASCRIPT),
                    LazyOutputArtifact("artifact7", { "LayerDocs".toByteArray().toList() }, ArtifactType.CSS),
                    OutputResourceGroup(
                        "Group 2",
                        setOf(
                            TextOutputArtifact("Artifact 8", "Hello, world!", ArtifactType.HTML),
                            BinaryOutputArtifact("art*fact/9", "LayerDocs".toByteArray().toList(), ArtifactType.JAVASCRIPT),
                        ),
                    ),

package com.layerdocs.core.util.node
 ...
 * For a full-fledged plain text rendering, see the `layerdocs-plaintext` module instead.
 *
...
/**
 * Strips rich content from [this] inline content and returns a new inline content with only one [com.layerdocs.core.ast.base.inline.Text] child,

 ...
 *
 * For example, in the LayerDocs source:
...
class AppendExpressionVisitor(
     ...
     * @throws InvalidExpressionEvalException if either [this] or [other] is a [NodeValue] (see [com.layerdocs.core.function.value.factory.ValueFactory.eval])
     */

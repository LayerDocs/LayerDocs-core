...
import com.layerdocs.core.localization.LocalizationTables
...
interface Context : PermissionHolder {
     ...
     * @see com.layerdocs.core.pipeline.Pipelines.getAttachedPipeline
     * @see com.layerdocs.core.pipeline.Pipelines.attach
     */
     ...
     * @see com.layerdocs.core.context.hooks.MediaStorerHook
     */
     ...
     * @throws com.layerdocs.core.localization.LocaleNotSetException if [locale] is not explicitly set and a locale is not set within [documentInfo]
     * @throws com.layerdocs.core.localization.LocalizationTableNotFoundException if the table does not exist
     * @throws com.layerdocs.core.localization.LocalizationKeyNotFoundException if the locale does not exist in the table
     * @throws com.layerdocs.core.localization.LocalizationKeyNotFoundException if the key does not exist in the table entry for the locale

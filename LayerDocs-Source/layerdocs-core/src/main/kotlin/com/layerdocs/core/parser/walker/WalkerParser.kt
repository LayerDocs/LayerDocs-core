package com.layerdocs.core.parser.walker
 ...
 * The term `Walker` refers to the fact this might be invoked by LayerDocs's lexer to walk through the source string,

 ...
 * @param R the type of the reference element (for example [com.layerdocs.core.ast.base.inline.ReferenceFootnote])
 * @param DN the type of the node that carries the definition (for example [com.layerdocs.core.ast.base.block.FootnoteDefinition])

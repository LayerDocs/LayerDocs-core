package com.layerdocs.core.function.value.data

import com.layerdocs.core.context.Context
import com.layerdocs.core.context.MutableContext
import com.layerdocs.core.function.SimpleFunction
...
import com.layerdocs.core.function.value.Destructurable
 ...
 * The return type is dynamic (a snippet of raw LayerDocs code is returned), hence it is evaluated and converted to a static type.

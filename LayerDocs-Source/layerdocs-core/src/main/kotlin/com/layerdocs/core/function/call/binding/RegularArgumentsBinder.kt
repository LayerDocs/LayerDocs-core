...
import com.layerdocs.core.function.error.MismatchingArgumentTypeException
import com.layerdocs.core.function.error.ParameterAlreadyBoundException
import com.layerdocs.core.function.error.UnnamedArgumentAfterNamedException
import com.layerdocs.core.function.error.UnresolvedParameterException
import com.layerdocs.core.function.reflect.DynamicValueConverter
import com.layerdocs.core.function.value.AdaptableValue
...
import com.layerdocs.core.function.value.isNone
...
class RegularArgumentsBinder(
    ...
    private fun getStaticallyTypedArgument(
        ...
        return when {
            ...
            // For instance, custom functions defined from a LayerDocs function have dynamic-type parameters.
            parameter.type == DynamicValue::class -> {
                argument.copy(expression = DynamicValue(value.unwrappedValue))
            }

            // NoneValue is accepted for nullable parameters, representing LayerDocs's equivalent of null.

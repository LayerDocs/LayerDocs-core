package com.layerdocs.core.media.passthrough
 ...
 * - Excluded from [com.layerdocs.core.context.hooks.LinkUrlResolverHook] resolution, preserving the `@` prefix intact.
 * - Excluded from [com.layerdocs.core.context.hooks.MediaStorerHook] registration, since the referenced file
 ...
 * is performed by the active [com.layerdocs.core.rendering.NodeRenderer].
 *
 * @see com.layerdocs.core.rendering.NodeRenderer
 */

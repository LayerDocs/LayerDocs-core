 ...
 * Note: subdocuments may have different working directories. For consistent results rely on [com.layerdocs.core.context.file.FileSystem.workingDirectory]
 ...
 * as the media architecture is defined by LayerDocs through a [com.layerdocs.core.context.hooks.MediaStorerHook].
 ...
 * @param errorHandler the error handler strategy to use when an error occurs in the pipeline, during the processing of a LayerDocs file

package com.layerdocs.core.document.sub
...
/**
 * A subdocument in a LayerDocs document is an independent unit that can be rendered separately,
 * can be linked from other documents, and can link to other subdocuments in order to create a graph of subdocuments,
 * available via [com.layerdocs.core.context.Context.sharedSubdocumentsData].
 *
 * Additionally, a [com.layerdocs.core.rendering.PostRenderer] may adopt different strategies for rendering
...
sealed interface Subdocument {
    ...
    /**
     * The root [Subdocument], which is the main document of the LayerDocs pipeline.
     ...
     * To get consistent results, rely on the context's [com.layerdocs.core.context.file.FileSystem.workingDirectory].

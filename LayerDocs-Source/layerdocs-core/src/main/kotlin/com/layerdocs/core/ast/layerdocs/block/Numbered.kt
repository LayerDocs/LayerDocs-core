...
import com.layerdocs.core.ast.attributes.location.SectionLocation
 ...
 * which is not known until the AST is fully traversed by [com.layerdocs.core.context.hooks.location.LocationAwareLabelStorerHook].
 *
 * After the traversal, the [com.layerdocs.core.context.hooks.location.NumberedEvaluatorHook] will evaluate and assign the [children] of this node, ready to be rendered.
 *
 * Since the evaluation does not happen within [com.layerdocs.core.function.call.FunctionCallNodeExpander],
 ...
 * @see com.layerdocs.core.context.hooks.location.LocationAwareLabelStorerHook for storing locations
 * @see com.layerdocs.core.context.hooks.location.NumberedEvaluatorHook for evaluating [location] and [childrenSupplier]
 * @see com.layerdocs.core.document.numbering.NumberingFormat
 */
class Numbered(
    val key: String,

package com.layerdocs.core.rendering
...
interface PostRenderer {
     ...
     * which complies with [com.layerdocs.core.pipeline.Pipeline.execute]'s output type.
     *
     * Wrapping can happen by:
     * - Grouping the resources into an [com.layerdocs.core.pipeline.output.OutputResourceGroup] (e.g. HTML output).

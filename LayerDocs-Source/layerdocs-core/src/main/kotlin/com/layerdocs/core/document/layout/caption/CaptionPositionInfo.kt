 ...
 * @param figures position of captions for [com.layerdocs.core.ast.layerdocs.block.Figure], if different from the default
 * @param tables position of captions for [com.layerdocs.core.ast.base.block.Table], if different from the default
 * @param codeBlocks position of captions for [com.layerdocs.core.ast.base.block.Code], if different from the default
 */
@Mergeable

...
/**
 * A custom `citeproc-java` [BaseFormat] that produces LayerDocs AST nodes
 ...
 */
internal class LayerDocsCslFormat : BaseFormat() {
    ...
    override fun getName(): String = "layerdocs"
     ...
     * - **Remaining tokens**: the entry content, converted to LayerDocs AST nodes
     *

...
/**
 * Regex patterns for [com.layerdocs.core.flavor.base.BaseMarkdownFlavor] inlines.
 */
open class BaseMarkdownInlineTokenRegexPatterns {
     ...
     * As an extension, LayerDocs introduces an optional `(WxH)` or `(W) to be added after the `!` the end which specifies

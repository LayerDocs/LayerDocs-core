 ...
 * Depth 0 cannot be achieved with plain Markdown, but it can be supplied by a LayerDocs function.
 */
 ...
 * A useful use case would be, for example, in combination with a [com.layerdocs.core.context.toc.TableOfContents].
 * Depth 0 cannot be achieved with plain Markdown, but it can be supplied by the LayerDocs function `.marker`.
 */

package com.layerdocs.core.context.file

import com.layerdocs.core.context.ChildContext
...
enum class RootGranularity {
    /**
     * The root is the parent directory of the target file being processed by the `layerdocs compile` command
     */
    PROJECT,

package com.layerdocs.core.function.value.factory
...
import com.layerdocs.core.ast.base.inline.PlainTextNode
...
import com.layerdocs.core.function.expression.SafeExpression
import com.layerdocs.core.function.expression.eval
import com.layerdocs.core.function.layerdocsName
import com.layerdocs.core.function.reflect.FromDynamicType
...
import com.layerdocs.core.function.value.IterableValue
...
import com.layerdocs.core.function.value.factory.ValueFactory.eval
import com.layerdocs.core.function.value.factory.ValueFactory.expression
import com.layerdocs.core.function.value.factory.ValueFactory.iterable
import com.layerdocs.core.function.value.factory.ValueFactory.lambda
import com.layerdocs.core.function.value.factory.ValueFactory.range
import com.layerdocs.core.function.value.factory.ValueFactory.safeExpression
import com.layerdocs.core.function.value.factory.ValueFactory.size
import com.layerdocs.core.lexer.Lexer
import com.layerdocs.core.lexer.Token
import com.layerdocs.core.lexer.patterns.PatternHelpers
import com.layerdocs.core.misc.color.Color
import com.layerdocs.core.misc.color.decoder.decode
import com.layerdocs.core.parser.walker.lambda.LambdaParser
import com.layerdocs.core.pipeline.error.PipelineException
import com.layerdocs.core.pipeline.error.UnattachedPipelineException
...
import com.layerdocs.core.util.node.conversion.list.MarkdownListToCollectionValue
import com.layerdocs.core.util.node.conversion.list.MarkdownListToDictionaryValue
 ...
 * @see com.layerdocs.core.function.reflect.FromDynamicType
 * @see com.layerdocs.core.function.reflect.DynamicValueConverter.convertTo
 */
object ValueFactory {
    /**
    ...
    fun enum(
        ...
        when (raw) {
            is Enum<*> -> {
                ...
                values
                    .find { it.layerdocsName.equals(raw.toString(), ignoreCase = true) }
                    ?.let { EnumValue(it) }
            }
        }
     ...
     * This is generally an *unsafe* expression, as evaluating it may throw an [com.layerdocs.core.function.error.internal.InvalidExpressionEvalException].
    ...
    /**
     * Evaluates a dynamic expression from a raw string input.
     * This is a safe expression, meaning that if an [com.layerdocs.core.function.error.internal.InvalidExpressionEvalException] is caught while

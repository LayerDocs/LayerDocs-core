...
import com.layerdocs.core.function.value.data.subList
...
import com.layerdocs.stdlib.internal.AlphanumericComparator
import com.layerdocs.stdlib.internal.Ordering
import com.layerdocs.stdlib.internal.Sorting
import com.layerdocs.stdlib.internal.sortedBy
import java.io.File
 ...
 *
 * If set to [RootGranularity.PROJECT], the root is the parent directory of the target file being processed by the `layerdocs compile` command.
...
enum class CsvParsingMode(
    ...
    /** Cell content is treated as inline LayerDocs. */

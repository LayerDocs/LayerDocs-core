...
import com.layerdocs.stdlib.internal.asDouble
 ...
 */
val Collection: LayerDocsModule =
    moduleOf(
        ::collectionGet,
        ::collectionFirst,
        ::collectionSecond,
 ...
 * @return the index of the element in LayerDocs (starting at 1)
 */
private fun layerdocsIndexToKotlin(index: Int) = index - INDEX_STARTS_AT
...
) = nativeCollectionGet(layerdocsIndexToKotlin(index), collection, fallback)

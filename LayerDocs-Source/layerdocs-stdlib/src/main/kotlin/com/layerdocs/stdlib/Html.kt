 ...
 * @throws com.layerdocs.core.permissions.MissingPermissionException if [Permission.NativeContent] is not granted
 * @wiki html
 */
fun html(
...
private const val CSS_PROPERTY_PREFIX = "--ld-"

/**
 * Overrides the value of LayerDocs CSS properties.
 *
 * Each entry corresponds to a LayerDocs CSS property name and its value.
 * The names will be prefixed with `--ld-` to match the LayerDocs CSS variable naming convention.
 *
 * ```yaml
 * .cssproperties
 *   - background-color: green
 ...
 * ```
 *
 * For a complete list of properties, see the [global theme](https://github.com/SatyamPote/layerdocs/blob/main/layerdocs-html/src/main/scss/global.scss).

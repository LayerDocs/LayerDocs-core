...
import com.layerdocs.core.context.SharedContext
...
import com.layerdocs.stdlib.internal.asString
import java.io.Reader

/**
 * `Ecosystem` stdlib module exporter.
 * This module handles interaction between LayerDocs sources.
 */
val Ecosystem: LayerDocsModule =
    moduleOf(
        ::include,
        ::includeAll,
        ::subdocument,
...
/**
 * Includes the parsed content of the given raw LayerDocs [code], read by [reader], in the current document.
 ...
 * @param reader reader of the raw LayerDocs source to include
 ...
 * - Reads a LayerDocs file and includes its parsed content in the current document,
 ...
 * @throws IllegalArgumentException if the loaded LayerDocs source cannot be evaluated
 * @wiki including-other-layerdocs-files
 */
fun include(

...
import com.layerdocs.core.ast.base.block.marker
...
import com.layerdocs.core.document.layout.caption.merge
import com.layerdocs.core.document.layout.font.FontInfo
import com.layerdocs.core.document.layout.page.PageFormatInfo
import com.layerdocs.core.document.layout.page.PageFormatSelector
...
import com.layerdocs.core.document.layout.paragraph.merge
...
import com.layerdocs.core.document.numbering.merge
...
import com.layerdocs.core.function.value.dictionaryOf
...
import com.layerdocs.stdlib.internal.loadFontFamily

/**
 * `Document` stdlib module exporter.
 * This module handles document information and details.
 * @see com.layerdocs.core.document.DocumentInfo
 */
val Document: LayerDocsModule =
    moduleOf(
        ::docType,
        ::docName,
        ::docDescription,
 ...
 *     - website: https://github.com/SatyamPote/layerdocs
 *   - Jane Doe
 ...
 *
 * For a list of supported locales for built-in localizations, see [here](https://layerdocs.com/wiki/localization).
 *
 * ```
 * .doclang {en}
 * ```
 ...
 *
 * Local and remote font resources are processed by the [media storage](https://layerdocs.com/wiki/media-storage).
